  ...
  return (
    <div className="page">
      <PageIntro
        ...
        description="Walk with the saints, follow today’s witness, and keep Catholic devotion close to daily youth life."
        ...
        <section className="section section--soft">
          <div className="container story-article">
            <article className="story-article__main">
              ...
              <p>
                {activeSaint?.excerpt ||
                  `${featuredSaint.name} is honoured by the Church today and can lead the parish family into prayer, courage, and faithful service.`}
              </p>
        ...
        <div className="container story-grid">
          {saints.length === 0 ? (
            <div className="panel empty-state">
              ...
              <p>When the parish office adds saint stories, they will appear here and can be scheduled to their proper day.</p>
            </div>
          ) : null}
