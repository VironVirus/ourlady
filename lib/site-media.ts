...
export const churchPhotos = {
  frontExterior: {
    ...
    alt: "Front view of Our Lady of Lourdes Catholic Church",
    position: "center 34%"
  },
  processionStreet: {
    src: "/images/church/procession-street.jpeg",
    alt: "Parish procession near the church grounds",
    position: "center 52%"
  },
  processionCourtyard: {
    src: "/images/church/procession-courtyard.jpeg",
    alt: "Parish gathering in the church courtyard",
    position: "center 42%"
  },
  altarInterior: {
  ...
  priest: {
    ...
    alt: "Parish priest of Our Lady of Lourdes Catholic Church",
    position: "center 20%"
  }
