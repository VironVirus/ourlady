...
export default async function PriestPage() {
  ...
  return (
    <div className="page">
      <PageIntro
        eyebrow="Priests"
        title="Chaplaincy Priests"
        description="Pastoral care, formation, and sacramental leadership."
        ...
        <div className="container split-grid">
          {content.priests.length > 0 ? (
            ...
            <div className="panel empty-state">
              ...
              <p>Chaplaincy priest information can be added later from the admin area.</p>
            </div>
          )}
        </div>
      </section>
