...
export default async function ReflectionsPage() {
  ...
  return (
    <div className="page">
      <PageIntro
        eyebrow="Reflections"
        title="Chaplaincy Reflections"
        description="Simple Catholic reflections for students, study, service, and daily witness."
        ...
        <div className="container story-grid">
          {content.reflections.length > 0 ? (
            ...
            <div className="panel empty-state">
              ...
              <p>Reflections can be added later when real chaplaincy content is ready.</p>
            </div>
          )}
        </div>
      </section>
