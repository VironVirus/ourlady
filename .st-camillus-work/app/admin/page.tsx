...
export default async function AdminPage({ searchParams }: AdminPageProps) {
  ...
  return (
    <AdminShell
      ...
      description={
        supabaseEnabled
          ? "Choose a section to manage chaplaincy content, stories, and uploads."
          : "Choose a section to manage chaplaincy content. Supabase uploads will turn on when the keys are added."
      }
      notice={notice}
    >
