  ...
  return (
    <div className="page">
      <PageIntro
        ...
        title="Student Departments and Formation"
        description="Faith, service, and chaplaincy life within the health sciences community."
        ...
        <div className="container dashboard-grid">
          {content.pastoralUnits.length > 0 ? (
            ...
            <div className="panel empty-state">
              <h2>No student department items yet.</h2>
              <p>Department-based chaplaincy details can be added later from the admin area.</p>
            </div>
          )}
        </div>
      </section>
