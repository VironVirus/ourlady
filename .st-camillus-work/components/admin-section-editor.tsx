        ...
        <section className="admin-section">
          <div className="admin-section__heading">
            <div>
              ...
              <h2>About section</h2>
              <p>Short chaplaincy story and highlights.</p>
            </div>
          </div>
          <div className="admin-grid">
            <label className="admin-field">
          ...
          <div className="admin-subsection__head">
            <div>
              ...
              <p className="admin-hint">
                If no custom day is added, the website uses the regular chaplaincy Mass timetable automatically.
              </p>
            </div>
          </div>
          <label className="admin-field">
        ...
        <div className="admin-subsection">
          <div className="admin-subsection__head">
            <div>
              ...
              <p className="admin-hint">
                Weekdays default to 6:00 AM at the chaplaincy. Sundays use the fallback chaplaincy Sunday timetable unless you override it here.
              </p>
            </div>
      ...
      <section className="admin-section">
        <div className="admin-section__heading">
          <div>
            ...
            <p>Manage optional student communities or association pages if you decide to use them later.</p>
          </div>
        </div>
      ...
      <section className="admin-section">
        <div className="admin-section__heading">
          <div>
            ...
            <h2>Important chaplaincy notices</h2>
            <p>Quick notices that show up across the chaplaincy website.</p>
          </div>
        </div>
      ...
      <section className="admin-section">
        <div className="admin-section__heading">
          <div>
            ...
            <h2>Departments and chaplaincy units</h2>
            <p>Manage student-focused units one at a time with a simpler add flow.</p>
          </div>
        </div>
        ...
        <div className="admin-subsection">
          <div className="admin-subsection__head">
            <div>
              ...
              <p className="admin-hint">Create a department, ministry, or chaplaincy unit.</p>
            </div>
